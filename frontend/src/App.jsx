...
function App() {
  ...
  const submitHandler=(e)=>{
    e.preventDefault()
    if(list.length>0){
      axios.post('https://to-do-list-backend-mojb.onrender.com/api/to_do_list',{list})
    .then((res)=>{
      console.log(res)
      setList("")
    })
  ...
  const onDelete=(index)=>{
    ...
    axios.delete(`https://to-do-list-backend-mojb.onrender.com/api/to_do_list/${taskId}`)
